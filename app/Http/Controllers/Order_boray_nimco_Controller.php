...
class Order_boray_nimco_Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($result);
        return view('Order_boray_nimco',compact('result'));
        // }
    }
    ...
    $order_details = new Order_boray_nimco_Model;
     $order_details->OrderInser($add_order );
        // dd('fvsd');
        return redirect()->route('boray_nimco.index')->with('success','Order Successfully Added');
    ...
    $order_details = new Order_boray_nimco_Model;
     ...
     return redirect()->route('boray_nimco.index')->with('success','Order Successfully Updated');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('boray_nimco.index')->with('success','Order Successfully Delete');
    ...
    function update_order($id, Request $request)
    {
        ...
        //   $nim_details  = $nimco_details->GetNimcodataById($result->nimco_order_id);
            ...
            // $nimco_details = new snack_boray_24_pc_Model;
            // $bory_details =  $bory_details->GetBoraydataById($result->insert_boray_pac);
            ...
            return redirect()->route('boray_nimco.index')->with('success','Order details Successfully Update');
