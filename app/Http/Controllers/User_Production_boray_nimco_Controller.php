...
class User_Production_boray_nimco_Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('nimco_boray_production',compact('result'));
    }
    ...
    $order_details = new Order_boray_nimco_Model;
     $order_details->OrderInser($add_order );
        // dd('fvsd');
        return redirect()->route('nimco_boray_production.index')->with('success','Order Successfully Added');
    ...
    $order_details = new Order_boray_nimco_Model;
     ...
     return redirect()->route('nimco_boray_production.index')->with('success','Order Successfully Updated');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('nimco_boray_production.index')->with('success','Order Successfully Delete');
